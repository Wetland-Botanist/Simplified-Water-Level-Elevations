...
Dataset Templates README:

- The 'Dataset Templates' folder provides blank CSV files with appropriate column headers (and blank cells) for the needed input datasets:
